...
namespace MyMLApp
{
    ...
    {
        public const string RetrainFilePath =  @"D:\VMcommunicate\CODE\Csharp\A_Template_模板\MyMLApp\MyMLApp\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.06374691F,L2Regularization=0.06588917F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
