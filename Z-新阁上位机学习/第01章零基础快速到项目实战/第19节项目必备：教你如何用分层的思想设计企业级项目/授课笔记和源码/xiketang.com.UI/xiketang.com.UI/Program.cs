...
namespace xiketang.com.UI
{
    class Program
    {
        ...
        {
            Console.WriteLine("欢迎大家参加喜科堂常老师的.NET全栈和上位机课程，现在是预科内容！");
            Console.WriteLine("常老师QQ：2934008878   客服老师QQ：995551859");
            Console.WriteLine("课程官网：xiketang.com");
            Console.WriteLine("您今天学的内容是：如何用分层的思想设计企业级项目");
            Console.WriteLine("目的：学好项目分层思想，为即将开始的项目实战做准备！");
            Console.WriteLine("------------------------------------------");
        ...
        {
            Course course = new Course { CourseId = 1049 };
            int result = new CourseService().DeleteCourse(course);
            Console.WriteLine("受影响的行数=" + result);
        }

        //第一次分类代码，但是发现数据操作对象依然没有完全独立
        //public static  void QueryCourseById()
        //{            
        //    SqlDataReader reader = new CourseService().QueryCourseById(1020);
