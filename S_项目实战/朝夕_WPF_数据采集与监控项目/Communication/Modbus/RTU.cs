    ...
    public class RTU
    {
        ...
        private void _serialPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            while(_serialPort.BytesToRead > 0)
            {
                ...
                _byteBuffer[_receiveBytes] = _receiveBytes;
                _receiveByteCount++;
        ...
        public async Task<bool> Send(int slaveAddress, byte funcCode, int startAddr, int len)
        {
            ...
            sendBuffer.Add((byte)slaveAddress);
...
#region CRC校验
        ...
        /// <summary>
        /// 函数功能：Modbus CRC16 校验计算函数, 计算结果是高位在前，需要转换才能发送
        /// </summary>
        /// <param name="pucFrame">待计算的数据首地址</param>
