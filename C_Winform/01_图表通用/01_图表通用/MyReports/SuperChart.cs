...
namespace _01_图表通用
{
    ...
    public class SuperChart
    {
        ...
        /// 绘制图表的通用方法
        /// </summary>
        /// <param name="chartType">绘制图表的类型</param>
        /// <param name="dataList">绘制图表的数据</param>
